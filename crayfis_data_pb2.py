...
# source: crayon/crayfis_data.proto
...
DataChunk = _reflection.GeneratedProtocolMessageType('DataChunk', (_message.Message,), dict(
  ...
  __module__ = 'crayon.crayfis_data_pb2'
